...
if (process.env.NODE_ENV !== "production") {
  (function () {
    ...
    _assign(pureComponentPrototype, Component.prototype); // Object.assign() 方法用于将所有可枚举属性的值从一个或多个源对象复制到目标对象。它将返回目标对象。
    ...
    function createElement(type, config, children) {
      ...
      var childrenLength = arguments.length - 2; // 减去 type 和 config
      if (childrenLength === 1) {
